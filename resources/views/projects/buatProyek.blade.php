...
<div class="flex flex-col gap-8 pb-24">
    ...
    <form action="{{ route('projects.store') }}" method="POST" class="space-y-8">
        @csrf
        <x-project.form question="Nama Proyek" name="project_name" type="text" placeholder="Masukkan nama proyek" :value="old('project_name')" />
        ...
        <div class="space-y-4">
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <input type="hidden" name="project_field" id="tag-hidden" value="{{ old('project_field') }}" />
            </div>
            <p class="text-xs text-slate-400">Tekan Spasi atau Enter untuk menambah tag</p>
        </div>

        <x-project.form question="Deskripsi Proyek" name="description" type="textarea" placeholder="Tuliskan jawabanmu disini" rows="5" :value="old('description')" />
        ...
        <x-project.form question="Informasi untuk pelamar setelah diterima" name="accepted_info" type="textarea" placeholder="Tuliskan jawabanmu disini" rows="5" :value="old('accepted_info')" />
...
<script>
    ...
    function addRoleElement(name) {
        ...
        div.innerHTML = `
            <input type="hidden" name="roles[${idx}][name]" value="${name}">
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="number" name="roles[${idx}][count]" id="count-${uid}" value="1" min="1" readonly
